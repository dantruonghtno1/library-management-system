                    ...
                    ?>
                        <nav style="float: right;">
                            <ul>
                                ...
                                <li><a href="books.php">GIÁ SÁCH&nbsp&nbsp&nbsp&nbsp</a></li>
                    ...
                    ?>
                        <nav>
                            <ul style="float: right;">
                                <li><a href="index.php">TRANG CHỦ&nbsp&nbsp&nbsp&nbsp</a></li>
                                <li><a href="books.php">GIÁ SÁCH&nbsp&nbsp&nbsp&nbsp</a></li>
                                <li><a href="student_login.php">ĐĂNG NHẬP&nbsp&nbsp&nbsp&nbsp</a></li>                            
                            </ul>
                        </nav>
                    <?php
                }
        ...
        <section>
            <div class="sec_img">
                ...
                <div class="box">
                    ...
                    <h1 style="text-align: center;font-size: 25px">Closes at: 18:00</h1> <br>
                </div>
            </div>
        </section>
